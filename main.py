...
favMovie = "Captain America: The Winter Soldier"
...
#Create histogram
plt.hist(actionMovieData["audience_rating"], range = (0, 100), bins = 20, color = "pink")

#Adds labels and adjusts histogram
plt.grid(True)
plt.title("Audience Ratings for Action Movies")
plt.xlabel("Audiaence Rating")
plt.ylabel("Number of Action Movies")

#Prints interpretation of histogram
print(
  "According to the histogram, we can see that the most values are between 60 and 65, and there are a lots of high ratings.\n"
)
...
#Create scatterplot
plt.scatter(data = actionMovieData, x = "audience_rating", y = "critic_rating", color = "pink")
...
print(
  "According to the scatter plot, we can see that the graph is positive and that the audience ratings are higher than the critic ratings.\n"
)
print()
